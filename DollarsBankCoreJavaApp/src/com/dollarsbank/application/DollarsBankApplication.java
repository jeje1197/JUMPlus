...
public class DollarsBankApplication {
	...
	private static final String FILE_PATH = "files/account_data";
	
	public static void main(String[] args){
		// Loads sample account data into controller
		loadSampleData();

		FileStorage.loadAccountListFromFile(controller, FILE_PATH);
		landingPage();

		FileStorage.saveAccountListToFile(controller, FILE_PATH);
	}
